...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" version="1.1.0" xmlns:se="http://www.opengis.net/se" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xlink="http://www.w3.org/1999/xlink">
  <NamedLayer>
    <se:Name>NaturaAreas</se:Name>
    <UserStyle>
      <se:Name>NaturaAreas</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>Natura SAC</se:Name>
          <se:Description>
            <se:Title>Natura SAC</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>label_fi</ogc:PropertyName>
              <ogc:Literal>Natura SAC</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
        ...
        <se:Rule>
          <se:Name>Natura SCI</se:Name>
          <se:Description>
            <se:Title>Natura SCI</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>label_fi</ogc:PropertyName>
              <ogc:Literal>Natura SCI</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
        ...
        <se:Rule>
          <se:Name>Natura SPA</se:Name>
          <se:Description>
            <se:Title>Natura SPA</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>label_fi</ogc:PropertyName>
              <ogc:Literal>Natura SPA</ogc:Literal>
            </ogc:PropertyIsEqualTo>
          </ogc:Filter>
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:GraphicFill>
                <se:Graphic>
                  <se:Mark>
                    ...
                    <se:Stroke>
                      <se:SvgParameter name="stroke">#728944</se:SvgParameter>
                    </se:Stroke>
                  </se:Mark>
                </se:Graphic>
              </se:GraphicFill>
          ...
          <se:TextSymbolizer>
            ...
            <se:Halo>
              ...
              <se:Fill>
                ...
                <se:SvgParameter name="fill-opacity">0.832</se:SvgParameter>
              </se:Fill>
            </se:Halo>
            <se:Fill>
