...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" version="1.1.0" xmlns:se="http://www.opengis.net/se" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xlink="http://www.w3.org/1999/xlink">
  <NamedLayer>
    <se:Name>MireProtectionSupplementary</se:Name>
    <UserStyle>
      <se:Name>MireProtectionSupplementary</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:PolygonSymbolizer>
              ...
              <se:GraphicFill>
                <se:Graphic>
                  <se:Mark>
                    ...
                    <se:Fill>
                      <se:SvgParameter name="fill">#835132</se:SvgParameter>
                    </se:Fill>
                    <se:Stroke>
                      <se:SvgParameter name="stroke">#835132</se:SvgParameter>
            ...
            <se:VendorOption name="distance">6,6</se:VendorOption>
          </se:PolygonSymbolizer>
          <se:LineSymbolizer>
            <se:Stroke>
              <se:SvgParameter name="stroke">#835132</se:SvgParameter>
          ...
          <se:TextSymbolizer>
            ...
            <se:Halo>
              ...
              <se:Fill>
                ...
                <se:SvgParameter name="fill-opacity">0.803</se:SvgParameter>
              </se:Fill>
            </se:Halo>
            <se:Fill>
