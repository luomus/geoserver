...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" version="1.1.0" xmlns:se="http://www.opengis.net/se" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xlink="http://www.w3.org/1999/xlink">
  <NamedLayer>
    <se:Name>NatureConservationAreas_Private</se:Name>
    <UserStyle>
      <se:Name>NatureConservationAreas_Private</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          ...
          <se:PolygonSymbolizer>
              ...
              <se:GraphicFill>
                <se:Graphic>
                  <se:Mark>
                    ...
                    <se:Fill>
                      <se:SvgParameter name="fill">#4ded25</se:SvgParameter>
                    </se:Fill>
                  </se:Mark>
                </se:Graphic>
              </se:GraphicFill>
            ...
            <se:Stroke>
              <se:SvgParameter name="stroke">#1f682c</se:SvgParameter>
        ...
        <se:Rule>
          ...
          <se:TextSymbolizer>
            <se:Label>
              <ogc:PropertyName>type_fi</ogc:PropertyName>
            </se:Label>
            <se:Font>
            ...
            <se:Halo>
              ...
              <se:Fill>
                ...
                <se:SvgParameter name="fill-opacity">0.801</se:SvgParameter>
              </se:Fill>
            </se:Halo>
            <se:Fill>
